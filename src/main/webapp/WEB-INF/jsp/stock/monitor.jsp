...
<html>
	...
	<body>
		...
		<h2 style="text-align: left;">MONIOR</h2>		
		<a id="clear" href="#" style="font-size: larger;">Clear</a>
		<a id="download" href="#" style="font-size: larger; margin-left: 15px;">Download (XLSX)</a>
		<br>
		<div id="MONITOR" style="width: 95.6%; height: 80%; max-height: 80%; font: small-caption;"></div>
	
		<script src="/stock-v1/static/js/monitor.js"></script>
	</body>
