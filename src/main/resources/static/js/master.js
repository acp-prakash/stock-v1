...
function createMASTERTable() {
    MASTERTable = new Tabulator(`#${TABLE_CONTAINER_ID}`, {
        ...
        columns: [
            ...
            { title: 'GS', field:'gCShortDays', sorter:'string',headerFilter:true, width:75},
            { title: 'GL', field:'gCLongDays',  sorter:'string',headerFilter:true, width:75},
            { title: 'DS', field:'dCShortDays', sorter:'string',headerFilter:true, width:75},
            { title: 'DL', field:'dCLongDays',  sorter:'string',headerFilter:true, width:75},
