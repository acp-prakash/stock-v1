...
function createSTOCKHISTORYTable() {
    STOCKHISTORYTable = new Tabulator(`#${TABLE_CONTAINER_ID}`, {
        ...
        columns: [
			...
			{ title: 'GS', field:'gCShortDate', headerFilter:true, width:80},
            { title: 'GL', field:'gCLongDate',  headerFilter:true, width:80},
            { title: 'DS', field:'dCShortDate', headerFilter:true, width:80},
            { title: 'DL', field:'dCLongDate',  headerFilter:true, width:80},
