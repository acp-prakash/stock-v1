...
public class LiveStockCache  {
	...
	public static List<Picks> getPicks() {
		...
		s.setExit2("26");
		s.setStop("24.13");
		s.setTargetDate("2024-05-23");
		s.setAddedDate("2024-04-12");
		s.setAddPrice("24.41");
		picksList.add(s);
		...
		s.setExit2("58.1");
		s.setStop("53.04");
		s.setTargetDate("2024-06-24");
		s.setAddedDate("2024-05-10");
		s.setAddPrice("55.01");
		picksList.add(s);
